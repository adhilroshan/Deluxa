...
final List<Content> myList =  [
  ...
  const Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.htsdof),
  const Content(name: 'Kakegurui', imageUrl: Assets.kakegurui),
  const Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesday),
  const Content(name: 'Black Mirror', imageUrl: Assets.blackMirror),
  const Content(name: 'Violet Evergarden', imageUrl: Assets.violetEvergarden),
  const Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.htsdof),
  const Content(name: 'Kakegurui', imageUrl: Assets.kakegurui),
  const Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesday),
...
final List<Content> originals =  [
  const Content(name: 'Stranger Things', imageUrl: Assets.strangerThings),
